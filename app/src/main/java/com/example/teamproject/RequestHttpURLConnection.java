...
//            os.close(); // 출력 스트림을 닫고 모든 시스템 자원을 해제.
            ...
            for(int i=0;i<jArray.length();i++) {
                ...
                String Name = (String) jObject1.get("Name");
                String TEL = (String) jObject1.get("TEL");
                String Open = (String) jObject1.get("Open");
                String Close = (String) jObject1.get("Close");
                String Waiting = (String) jObject1.get("Waiting");
...
//                String Close = (String) jObject2.get("Close");
                ...
                String M1 = (String) jObject2.optString("M1");
